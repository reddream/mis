...
public class ZipCompressor {
	...
	public static byte[] compress(byte[] bytes,String id) throws IOException{
		ByteArrayOutputStream  tempOStream = new ByteArrayOutputStream(bytes.length);
	    BufferedOutputStream  tempBOStream = new BufferedOutputStream(tempOStream);
	    ZipOutputStream  tempZStream = new ZipOutputStream(tempBOStream);
	    ZipEntry  tempEntry = new ZipEntry(id);
	    byte[] tempBytes = null;
