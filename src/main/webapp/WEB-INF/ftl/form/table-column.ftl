...
<#if i==-1>
	<th <#if align!="">align="${align}"</#if> <#if width!=""> width="${width}"</#if><#if class!=""> class="${class}"</#if><#if style!=""> style="${style}"</#if>><#if title!="">${title}<#else><@s.mt code=code text=code/></#if></th><#rt/>
<#else>
