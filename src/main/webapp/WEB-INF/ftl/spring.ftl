 ...
 * Macro to translate a message code into a message.
 -->
<#macro m code><@encodetext text=springMacroRequestContext.getMessage(code) encode='' /></#macro>
 ...
 * Macro to translate a message code with arguments into a message.
 -->
<#macro ma code, args><@encodetext text=springMacroRequestContext.getMessage(code, args) encode='' /></#macro>
